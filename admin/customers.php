...
<head>
    ...
    <title>FinHive | Admin | Customers</title>
</head>
...
<body onload="isAuthenticated(); displayProfile(); loadUnreadMessages(); generateAccountStatement(); print1();">
            ...
            <div class="container-fluid">
                <div class="form-head d-flex flex-wrap mb-sm-4 mb-3 align-items-center">
                    <div class="me-auto  d-lg-block mb-3">
                        <h2 class="text-black mb-0 font-w700">Customers</h2>
                        <p class="mb-0">Customer care & support</p>
                    </div>
                </div>
                <div class="col-xl-12 col-lg-12 col-xxl-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="needs-validation" id="account-filter-form">
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        <label for="account_officer_id">Account Officer</label>
                                        <select class="d-block default-select w-100" id="account_officer_id">
                                            <option value="">Choose...</option>
                                        </select>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <label for="gender">Gender</label>
                                        <select class="d-block default-select w-100" id="gender">
                                            <option value="">Choose...</option>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="d-block default-select w-100" id="identification">
                                            <option value="">Choose...</option>
                                ...
                                <table class="table verticle-middle table-striped table-responsive-md existing-customers" id="existing-customers">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">Account Officer Email</th>
                                            <th scope="col">Account Officer Phone</th>
    ...
    ***********************************-->
        ...
        <script src="../js/pages/admin/customers.js"></script>
