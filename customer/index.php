                            ...
                            <div class="card-body">
                                <div class="media align-items-center">
                                    <div class="media-body me-3">
                                        <h2 class="text-black font-w700 main-account-balance">9,825</h2>
                                        <p class="mb-0 text-black font-w600">Main Account Balance</p>
                                        <span><!-- <b class="text-success me-1">+0,5%</b> -->Current Standing</span>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="media align-items-center">
                                    <div class="media-body me-3">
                                        ...
                                        <span><!-- <b class="text-success me-1">+0,5%</b> -->Active Categories</span>
                                    </div>
                                    <div class="d-inline-block">
                                        <svg class="primary-icon" width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="col-xl-4 col-xxl-6 col-sm-6">
                        <div class="card card-bx">
                            <div class="card-body">
                                <div class="media align-items-center">
                                    <div class="media-body me-3">
                                        <h2 class="text-black font-w700 total-debits">653</h2>
