...
<head>
    ...
    <title>FinHive | Account Officer | Transactions</title>
</head>
...
<body onload="isAuthenticated(); displayProfile(); loadUnreadMessages(); generateAccountStatement(); print1();">
            ...
            <div class="container-fluid">
                <div class="form-head d-flex flex-wrap mb-sm-4 mb-3 align-items-center">
                    <div class="me-auto  d-lg-block mb-3">
                        ...
                        <p class="mb-0">Access all transactions across account holders under you!!!</p>
                    </div>
                </div>
                ...
                <div class="col-xl-12 col-lg-12 col-xxl-12 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Existing Transactions</h4>
                        </div>
                        <div class="card-body">
    ...
    ***********************************-->
    ...
    <script src="../js/pages/ao/transactions.js"></script>
