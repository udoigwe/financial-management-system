$(function () {
  ...
  $(document).ready(function () {
    ...
    $("#existing-customers").on("click", ".btn-edit", function () {
      ...
      var accountOfficerID = payloadClaim(token, "user_id");

      blockUI();

      //fetch user details
      $.ajax({
        url: `${API_URL_ROOT}/users?call=get_accounts&account_id=${accountID}&account_officer_id=${accountOfficerID}&token=${token}`,
        type: "GET",
        dataType: "json",
