	...
	var e = $(window).width(),
		...
		o = function () {
			$("#checkAll").on("change", function () {
				$("td input, .email-list .form-check-input").prop(
					"checked",
					$(this).prop("checked")
				);
			});
		...
		E = function () {
			if (jQuery(".dz-theme-mode").length > 0) {
				...
				var e = getCookie("data-theme-version");
				jQuery("body").attr("data-theme-version", e),
					jQuery(".dz-theme-mode").removeClass("active"),
					"dark" == e && jQuery(".dz-theme-mode").addClass("active");
			}
		};
	return {
		init: function () {
